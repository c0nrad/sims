...
if __name__ == "__main__":
    ...
    for moveset in movesets:
        ...
        probability_of_opposite_move_occuring_n, probability_of_opposite_move_occuring_d = calculate_group_probability(
        ...
        if probability_of_move_occuring_d / probability_of_opposite_move_occuring_d not in equal_eqn_map:
            equal_eqn_map[probability_of_move_occuring_d / probability_of_opposite_move_occuring_d] = [
                to_mathematica((probability_of_move_occuring_n / probability_of_opposite_move_occuring_n).subs(subs))
            ]
        else:
            equal_eqn_map[probability_of_move_occuring_d / probability_of_opposite_move_occuring_d].append(
                to_mathematica((probability_of_move_occuring_n / probability_of_opposite_move_occuring_n).subs(subs))
            )
