...
describe("matrix class", () => {
  ...
  it("mul scalar", () => {
    ...
    expect(m1.transpose().mulScalar(new Complex(3, 0)).equals(m2.transpose())).true;
  });
  ...
  it("tensor", () => {
    ...
    let m2 = new Matrix([[new Complex(4, 0)], [new Complex(6, 0)], [new Complex(3, 0)]]);

    let m3 = new Matrix([[new Complex(8, 0)], [new Complex(12, 0)], [new Complex(6, 0)], [new Complex(12, 0)], [new Complex(18, 0)], [new Complex(9, 0)]]);
