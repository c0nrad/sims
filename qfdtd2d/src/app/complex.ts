export class Complex {
  ...
  div(other: Complex) {
    ...
    return new Complex((this.real * other.real + this.imag * other.imag) / divisor, (this.imag * other.real - this.real * other.imag) / divisor);
  }
  ...
  equals(other: Complex, epsilon: number = 0.000001): boolean {
    return Math.abs(other.real - this.real) < epsilon && Math.abs(other.imag - this.imag) < epsilon;
  }

  set(real: number, imag: number) {
    (this.real as number) = real;
    (this.imag as number) = imag;
  }
